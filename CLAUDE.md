...
This repo is a practical skills collection for AI agents — not limited to Claude Code. Skills may include SKILL.md instruction files, Python utilities, TypeScript/JavaScript scripts, and shell scripts.
...
- To test a Claude Code skill: invoke it with `/<skill-name>` in a Claude Code session
